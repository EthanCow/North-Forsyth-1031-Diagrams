# North Forsyth §1031 — Internal Working Model

**Live site:** https://ethancow.github.io/North-Forsyth-1031-Diagrams/

Internal family tool — not legal advice, not client-facing. **No structure is locked.**
...
| File | Role |
|---|---|
| `docs/PROJECT_BRAIN.md` | Persistent project memory |
| `docs/DIGEST.md` | Master synthesis |
| `docs/research/` | 2026-06-14 research memos |
| `ai_rules.md` | Facts + agent rules |

Updated **2026-06-14**: Sept 1 timeline, path comparison, Riverway QI, Hanover org pattern, open exchanger entity.
